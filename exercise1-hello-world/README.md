...
3. Open `ext/hello/hello.c` and implement the `hello_world` function body and the `Init_hello` registration
4. Run `make` to compile the extension into a shared library
5. Run the tests from the exercise root: `ruby -Ilib test/test_hello.rb`
